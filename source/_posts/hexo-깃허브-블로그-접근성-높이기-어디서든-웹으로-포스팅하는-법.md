...
5. 깃허브 Oauth 설정 페이지로 돌아가서 임시로 써뒀던 **Authorization callback URL**에 `{프로젝트이름}.vercel.app/callback`으로 수정해주기
...
```bash node_modules\hexo-deployer-git\lib\deployer.js
